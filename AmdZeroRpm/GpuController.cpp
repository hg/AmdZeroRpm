...
GpuController::~GpuController() { ADL2_Main_Control_Destroy(mContext); }

bool GpuController::ToggleZeroRpm(bool enabled) noexcept {
  int index = 0;
  ...
  auto newValue = static_cast<int>(enabled);
